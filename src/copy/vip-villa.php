...
<main class="vip-villa">

    <section class="vip-villa-sec">
        <div class="container">
            <h2>vip-villa 1</h2>
            <div class="vip-villa-sec__wrapper">
                <div class="vip-villa-sec__image" style="background-image: url('images/challet-banner.png');">
                    <div class="vip-villa-sec__rate">
                        <h4>$ 250</h4>
                        <p>per day</p>
                    </div>
